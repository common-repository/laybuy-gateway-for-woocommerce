=== Laybuy for WooCommerce  ===
Plugin Name: Laybuy for WooCommerce
...
* PHP version 7.4 or greater (PHP 8.1+ is recommended)
* MySQL version 5.7 or greater (MySQL 8.0+ is recommended)
...
3. Browse to Admin -> Woocommerce -> Settings -> Checkout -> Laybuy, here you can set your Laybuy Merchant details and choose to display the product price breakdown. The breakdown is displayed with Woocommerce's Product actions, there is a link in the Description to show you where these will display.
...
* Remove laybuy page
* Resolve XSS issue reported in CVE-2024-21745
* Resolve Access Control issue

== Changelog ==
= 5.3.10 =
*Release Date: 26/03/2024

* Update price breakdown text to comply with legal legislation
* Remove laybuy page
* Resolve XSS issue reported in CVE-2024-21745

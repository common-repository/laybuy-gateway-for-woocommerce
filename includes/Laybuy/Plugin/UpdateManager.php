...
class Laybuy_Plugin_UpdateManager
{
    ...
    public function update()
    {
        ...
        // update to 5.3.10
        if ($this->pluginDbVersion && version_compare($this->pluginDbVersion, '5.3.10', '<')) {
            $this->update_5_3_10();
        }
    ...
    public function update_5_3_10()
    {
        $settings = (array) get_option( 'woocommerce_laybuy_settings', true );

        $settings['product_pages_info_text'] = 'or 6 interest-free payments of <strong>[AMOUNT]</strong> with [laybuy_logo] <a onclick="window.open(this.href, \'popup\', \'width=450,height=650\'); return false;" class="laybuy-popup-link" href="https://popup.laybuy.com">Learn more</a>';
        $settings['category_pages_info_text'] = 'or 6 interest-free payments of <strong>[AMOUNT]</strong> with [laybuy_logo] <a onclick="window.open(this.href, \'popup\', \'width=450,height=650\'); return false;" class="laybuy-popup-link" href="https://popup.laybuy.com">Learn more</a>';
        $settings['cart_page_info_text'] = '<tr><td colspan="2" style="font-size: 14px">or 6 interest-free payments of <strong>[AMOUNT]</strong> with [laybuy_logo] <a onclick="window.open(this.href, \'popup\', \'width=450,height=650\'); return false;" class="laybuy-popup-link" href="https://popup.laybuy.com">Learn more</a></td></tr>';
        $settings['checkout_page_info_text'] = 'or 6 interest-free payments of <strong>[AMOUNT]</strong> with [laybuy_logo] <a onclick="window.open(this.href, \'popup\', \'width=450,height=650\'); return false;" class="laybuy-popup-link" href="https://popup.laybuy.com">Learn more</a>';
